...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ve55cri.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ve55cri.containers.anotherwebservice.com/
...
```
git clone git@github.com:BagasZkyn/go-whatsapp-web-multidevice.git
cd container-ve55cri
```
...
```
docker attach container-ve55cri
```
